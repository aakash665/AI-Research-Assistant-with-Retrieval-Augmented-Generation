...
def initialize_default_documents(state: dict) -> tuple[dict, str]:
    try:
...
def reset_chat(state: dict) -> tuple[list, dict, str]:
...
DEFAULT_APP_STATE = build_app_state()
DEFAULT_APP_STATUS = status_text(DEFAULT_APP_STATE)
